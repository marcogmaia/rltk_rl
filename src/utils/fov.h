...
typedef struct {
    ...
    /*@null@*/ void (*apply)(void* map, int x, int y, int dx, int dy,
                             void* src);
...
#define fov_direction_opposite(direction)                                      \
    ((fov_direction_type)(((direction) + 4) & 0x7))
